...
Collects and synthesizes attributed stakeholder input without manufacturing consensus. Static: no network calls, no remote fetch, no telemetry, and no auto-update.
